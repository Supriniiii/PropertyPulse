...
<html lang="en">
  ...
  <body>
          ...
          <nav>
            <section class="dicover">
              ...
              <ul>
                ...
                <li>
                  <a href="../Property_Owner_Dashboard_Tabs/dynamic_full_calender.php">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
      ...
      <main class="content-wrap">
        <button id="addFormButton" class="btn btn-primary">
        <i class="fas fa-plus"></i>
        <i class="fas fa-building"></i>
    </button>
<form id="formContainer" action="../../Controller/addApartment.php" class="apartment-form">
    ...
    addFormButton.addEventListener('click', () => {
        ...
        form.innerHTML = `
            ...
            <div class="form-group">
                ...
                <input type="number" id="bathrooms" name="bathrooms[]" step="0.1">
            </div>
            <div class="form-group">
        ...
        formContainer.insertBefore(form, formContainer.lastElementChild);
    });
</script>
  </body>
</html>
