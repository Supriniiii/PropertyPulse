...
<li>
 ...
 <main class="content-wrap">
  ...
  <div class="background">
    <div class="container">
      <div class="card">
        <button onclick="window.location.href='list_tenants.php'" class="action-button">
          View Tenants
        </button>
      </div>
      <div class="card">
        <button onclick="window.location.href='list_applicants.php'" class="action-button">
          View Tenant Applications
        </button>
      </div>
      <div class="card">
        <button onclick="window.location.href='summary_report.php'" class="action-button">
          Summary Report
        </button>
      </div>
    </div>
