...
?>
 ...
 <div class="container">
        <h1>Residence Application Outcome</h1>
        <?php
        if (isset($_SESSION['exitOrNot']) && !empty($_SESSION['exitOrNot'])) {
            echo "<p>" . htmlspecialchars($_SESSION['exitOrNot']) . "</p>";
           echo "<p>" . htmlspecialchars($_SESSION['application_status']) . "</p>";
        } else {
            echo "<p>No application status available.</p>";
        }
        ?>
        <a href="../tenant_dashboard.php">Go back to the home page</a>
    </div>
<!--
