...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="Service_Provider_Dashboard_Tabs/style.css" />
    <style>
 .person-boxes {
  display: flex;
  ...
  <div class="person-box">
    ...
    <div class="box-content">
      <div class="box-bio">
        ...
        <p class="bio-position">Service Provider</p>
      </div>
      <div class="box-actions">
        <a href="Service_Provider_Dashboard_Tabs/workOrdersAndRequests.php" class="action-button">
        ...
        <a href="Service_Provider_Dashboard_Tabs/communications.php" class="action-button">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
